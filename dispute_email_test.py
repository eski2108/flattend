...
5. Show me the exact button URL that will be in the email: https://order-confirmation-2.preview.emergentagent.com/admin/disputes/{dispute_id}
...
class DisputeEmailTester:
        ...
        if success:
            try:
                ...
                if data.get('success') and data.get('dispute'):
                    ...
                    expected_url = f"https://order-confirmation-2.preview.emergentagent.com/admin/disputes/{self.dispute_id}"
    ...
    def step_5_show_email_url(self):
        ...
        admin_url = f"https://order-confirmation-2.preview.emergentagent.com/admin/disputes/{self.dispute_id}"
        
        print(f"   🎯 EXACT EMAIL BUTTON URL:")
        print(f"   {admin_url}")
        print(f"")
        print(f"   📋 URL Components:")
        print(f"   - Base URL: https://order-confirmation-2.preview.emergentagent.com")
    ...
    def run_dispute_email_test(self):
        ...
        if success:
            ...
            print(f"✅ Clickable URL: https://order-confirmation-2.preview.emergentagent.com/admin/disputes/{self.dispute_id}")
            print(f"✅ URL Format: /admin/disputes/{self.dispute_id} (NOT ?dispute_id=)")
            return 0
        else:
