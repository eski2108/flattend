...
5. Show me the exact button URL that will be in the email: https://p2p-trader-board.preview.emergentagent.com/admin/disputes/{dispute_id}
...
class DisputeEmailTester:
    ...
    def step_5_show_email_url(self):
        ...
        admin_url = f"https://p2p-trader-board.preview.emergentagent.com/admin/disputes/{self.dispute_id}"
        
        print(f"   🎯 EXACT EMAIL BUTTON URL:")
        print(f"   {admin_url}")
        print(f"")
        print(f"   📋 URL Components:")
        print(f"   - Base URL: https://p2p-trader-board.preview.emergentagent.com")
