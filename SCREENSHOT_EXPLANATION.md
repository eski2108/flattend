...
**URL:** `https://i18n-p2p-fixes.preview.emergentagent.com/#/deposit/btc`
...
**URL:** `https://i18n-p2p-fixes.preview.emergentagent.com/#/register`
...
```
Step 1: Go to https://i18n-p2p-fixes.preview.emergentagent.com/#/register
...
Step 4: After successful registration/login, navigate to:
   https://i18n-p2p-fixes.preview.emergentagent.com/#/deposit/btc
...
Step 6: Navigate to:
   https://i18n-p2p-fixes.preview.emergentagent.com/#/trading
...
```
Step 1: Open https://i18n-p2p-fixes.preview.emergentagent.com
