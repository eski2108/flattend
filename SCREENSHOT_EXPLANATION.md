...
**URL:** `https://balance-sync-repair.preview.emergentagent.com/#/deposit/btc`
...
**URL:** `https://balance-sync-repair.preview.emergentagent.com/#/register`
...
```
Step 1: Go to https://balance-sync-repair.preview.emergentagent.com/#/register
...
Step 4: After successful registration/login, navigate to:
   https://balance-sync-repair.preview.emergentagent.com/#/deposit/btc
...
```
Step 1: Open https://balance-sync-repair.preview.emergentagent.com
