...
**URL:** `https://order-confirmation-2.preview.emergentagent.com/#/deposit/btc`
...
**URL:** `https://order-confirmation-2.preview.emergentagent.com/#/register`
...
```
Step 1: Go to https://order-confirmation-2.preview.emergentagent.com/#/register
...
Step 4: After successful registration/login, navigate to:
   https://order-confirmation-2.preview.emergentagent.com/#/deposit/btc
...
Step 6: Navigate to:
   https://order-confirmation-2.preview.emergentagent.com/#/trading
...
```
Step 1: Open https://order-confirmation-2.preview.emergentagent.com
