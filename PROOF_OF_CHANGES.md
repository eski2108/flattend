...
### NOWPayments API:
```bash
$ curl https://money-trail-4.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://money-trail-4.preview.emergentagent.com/#/register
2. Create account
...
### Deployment Status:
✅ Live URL: https://money-trail-4.preview.emergentagent.com
