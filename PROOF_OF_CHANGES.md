...
```bash
$ curl https://order-confirmation-2.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://order-confirmation-2.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://order-confirmation-2.preview.emergentagent.com/#/register
2. Create account
