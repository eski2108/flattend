...
```bash
$ curl https://i18n-p2p-fixes.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://i18n-p2p-fixes.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://i18n-p2p-fixes.preview.emergentagent.com/#/register
2. Create account
