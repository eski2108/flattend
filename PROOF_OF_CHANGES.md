...
```bash
$ curl https://fee-analytics.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://fee-analytics.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://fee-analytics.preview.emergentagent.com/#/register
2. Create account
