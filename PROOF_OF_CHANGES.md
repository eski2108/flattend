...
```bash
$ curl https://balance-sync-repair.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://balance-sync-repair.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://balance-sync-repair.preview.emergentagent.com/#/register
2. Create account
