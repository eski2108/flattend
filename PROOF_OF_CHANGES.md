...
```bash
$ curl https://neon-vault-1.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://neon-vault-1.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://neon-vault-1.preview.emergentagent.com/#/register
2. Create account
...
### Deployment Status:
✅ Live URL: https://neon-vault-1.preview.emergentagent.com
