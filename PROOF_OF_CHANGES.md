...
```bash
$ curl https://p2pdispute.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://p2pdispute.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://p2pdispute.preview.emergentagent.com/#/register
2. Create account
