...
```bash
$ curl https://crypto-2fa-update.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://crypto-2fa-update.preview.emergentagent.com/api/nowpayments/currencies
...
### Deployment Status:
✅ Live URL: https://crypto-2fa-update.preview.emergentagent.com
