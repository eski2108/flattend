...
```bash
$ curl https://crypto-alert-hub-2.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://crypto-alert-hub-2.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://crypto-alert-hub-2.preview.emergentagent.com/#/register
2. Create account
...
### Deployment Status:
✅ Live URL: https://crypto-alert-hub-2.preview.emergentagent.com
