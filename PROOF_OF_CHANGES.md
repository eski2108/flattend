...
```bash
$ curl https://crypto-integrify.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend"}
```

### NOWPayments API:
```bash
$ curl https://crypto-integrify.preview.emergentagent.com/api/nowpayments/currencies
...
```
1. Go to https://crypto-integrify.preview.emergentagent.com/#/register
2. Create account
