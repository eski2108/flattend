...
**How to Test:**
1. Go to: https://gridbot-app.preview.emergentagent.com/auth
...
- Redirect URI: `https://gridbot-app.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://gridbot-app.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://gridbot-app.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://gridbot-app.preview.emergentagent.com/api/auth/google"
```
