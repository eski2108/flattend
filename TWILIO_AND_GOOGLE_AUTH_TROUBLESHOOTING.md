...
**How to Test:**
1. Go to: https://cryptolaunch-9.preview.emergentagent.com/auth
...
- Redirect URI: `https://cryptolaunch-9.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://cryptolaunch-9.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://cryptolaunch-9.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://cryptolaunch-9.preview.emergentagent.com/api/auth/google"
```
