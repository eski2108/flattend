...
**How to Test:**
1. Go to: https://coinhubxrepo.preview.emergentagent.com/auth
...
3. Under "Authorized redirect URIs", ADD:
   ```
   https://coinhubxrepo.preview.emergentagent.com/api/auth/google/callback
   ```
4. Save changes
...
- Redirect URI: `https://coinhubxrepo.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://coinhubxrepo.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://coinhubxrepo.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://coinhubxrepo.preview.emergentagent.com/api/auth/google"
```
