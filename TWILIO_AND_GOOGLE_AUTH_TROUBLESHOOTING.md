...
**How to Test:**
1. Go to: https://tradeliquidity.preview.emergentagent.com/auth
...
- Redirect URI: `https://tradeliquidity.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://tradeliquidity.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://tradeliquidity.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://tradeliquidity.preview.emergentagent.com/api/auth/google"
```
