...
**How to Test:**
1. Go to: https://tradingplatform-14.preview.emergentagent.com/auth
...
- Redirect URI: `https://tradingplatform-14.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://tradingplatform-14.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://tradingplatform-14.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://tradingplatform-14.preview.emergentagent.com/api/auth/google"
```
