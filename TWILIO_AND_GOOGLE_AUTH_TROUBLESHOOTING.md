...
**How to Test:**
1. Go to: https://p2pdispute.preview.emergentagent.com/auth
...
- Redirect URI: `https://p2pdispute.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://p2pdispute.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://p2pdispute.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://p2pdispute.preview.emergentagent.com/api/auth/google"
```
