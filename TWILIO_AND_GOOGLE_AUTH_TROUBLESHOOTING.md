...
**How to Test:**
1. Go to: https://coinhubx-refresh.preview.emergentagent.com/auth
...
3. Under "Authorized redirect URIs", ADD:
   ```
   https://coinhubx-refresh.preview.emergentagent.com/api/auth/google/callback
   ```
4. Save changes
...
- Redirect URI: `https://coinhubx-refresh.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://coinhubx-refresh.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://coinhubx-refresh.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://coinhubx-refresh.preview.emergentagent.com/api/auth/google"
```
