...
**Test:**
```bash
curl https://quickstart-27.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://quickstart-27.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
