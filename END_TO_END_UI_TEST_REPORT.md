...
**Test:**
```bash
curl https://payflow-crypto-3.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://payflow-crypto-3.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
