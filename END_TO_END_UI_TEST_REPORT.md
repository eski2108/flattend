...
**Test:**
```bash
curl https://exchange-repair.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://exchange-repair.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
