...
**Test:**
```bash
curl https://wallet-nav-repair.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://wallet-nav-repair.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
