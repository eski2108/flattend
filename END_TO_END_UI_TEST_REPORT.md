...
**Test:**
```bash
curl https://nowpay-debug.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://nowpay-debug.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
