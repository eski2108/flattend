...
**Test:**
```bash
curl https://crypto-2fa-update.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://crypto-2fa-update.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
