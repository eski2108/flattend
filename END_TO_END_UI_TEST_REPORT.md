...
**Test:**
```bash
curl https://cryptodash-22.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://cryptodash-22.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
