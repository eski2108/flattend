...
**Test:**
```bash
curl https://neon-finance-5.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://neon-finance-5.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
