...
```bash
POST https://p2p-repair-1.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://p2p-repair-1.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://p2p-repair-1.preview.emergentagent.com  
