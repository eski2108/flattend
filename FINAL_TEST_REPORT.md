...
```bash
POST https://tradewatch-13.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://tradewatch-13.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://tradewatch-13.preview.emergentagent.com  
