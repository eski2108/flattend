...
```bash
POST https://trade-master-126.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://trade-master-126.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
