...
```bash
POST https://coinhub-rescue.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://coinhub-rescue.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://coinhub-rescue.preview.emergentagent.com  
