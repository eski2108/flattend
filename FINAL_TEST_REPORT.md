...
```bash
POST https://payflow-crypto-3.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://payflow-crypto-3.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://payflow-crypto-3.preview.emergentagent.com  
