...
```bash
POST https://multilingual-crypto-2.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://multilingual-crypto-2.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
