...
```bash
POST https://trading-perf-boost.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://trading-perf-boost.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
