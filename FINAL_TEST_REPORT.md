...
```bash
POST https://layout-restore-2.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://layout-restore-2.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
