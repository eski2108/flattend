...
```bash
POST https://signal-shield-4.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://signal-shield-4.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://signal-shield-4.preview.emergentagent.com  
