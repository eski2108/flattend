...
```bash
POST https://trade-form-polish.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://trade-form-polish.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://trade-form-polish.preview.emergentagent.com  
