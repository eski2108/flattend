...
```bash
POST https://neon-finance-5.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://neon-finance-5.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://neon-finance-5.preview.emergentagent.com  
