...
```bash
POST https://nowpay-debug.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://nowpay-debug.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://nowpay-debug.preview.emergentagent.com  
