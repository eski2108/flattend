...
```bash
POST https://crypto-alert-hub-2.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://crypto-alert-hub-2.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://crypto-alert-hub-2.preview.emergentagent.com  
