...
```bash
POST https://fixdisputeflow.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://fixdisputeflow.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://fixdisputeflow.preview.emergentagent.com  
