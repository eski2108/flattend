...
```bash
POST https://wallet-nav-repair.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://wallet-nav-repair.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
