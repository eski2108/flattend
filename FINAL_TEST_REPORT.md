...
```bash
POST https://fund-release-1.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://fund-release-1.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://fund-release-1.preview.emergentagent.com  
