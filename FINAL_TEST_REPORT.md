...
```bash
POST https://crypto-2fa-update.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://crypto-2fa-update.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
