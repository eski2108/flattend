...
```bash
POST https://pixelperfect-trade.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://pixelperfect-trade.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
