...
```bash
POST https://crypto-wallet-ui-3.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://crypto-wallet-ui-3.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
