...
```bash
POST https://crypto-logo-update.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://crypto-logo-update.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
