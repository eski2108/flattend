...
```bash
POST https://tradingbot-hub-13.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://tradingbot-hub-13.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
