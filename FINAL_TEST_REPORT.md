...
```bash
POST https://musing-brown-1.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://musing-brown-1.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://musing-brown-1.preview.emergentagent.com  
