...
```bash
POST https://order-confirmation-2.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://order-confirmation-2.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://order-confirmation-2.preview.emergentagent.com  
