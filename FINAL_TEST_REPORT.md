...
```bash
POST https://monitorcrypto.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://monitorcrypto.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://monitorcrypto.preview.emergentagent.com  
