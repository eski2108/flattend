...
```bash
POST https://atomic-pay-fix.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://atomic-pay-fix.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://atomic-pay-fix.preview.emergentagent.com  
