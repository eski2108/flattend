...
```bash
POST https://earn-rewards-21.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://earn-rewards-21.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://earn-rewards-21.preview.emergentagent.com  
