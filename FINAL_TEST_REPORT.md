...
```bash
POST https://tradehub-268.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://tradehub-268.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://tradehub-268.preview.emergentagent.com  
