...
```bash
POST https://premium-wallet-hub.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://premium-wallet-hub.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
