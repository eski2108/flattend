...
```bash
POST https://savingsflow-1.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://savingsflow-1.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://savingsflow-1.preview.emergentagent.com  
