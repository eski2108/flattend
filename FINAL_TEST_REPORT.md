...
```bash
POST https://express-buy-flow.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://express-buy-flow.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
