...
```bash
POST https://i18n-p2p-fixes.preview.emergentagent.com/api/p2p/create-ad
...
```bash
GET https://i18n-p2p-fixes.preview.emergentagent.com/api/p2p/my-ads/aby-925330f1
```
...
**Preview URL:** https://i18n-p2p-fixes.preview.emergentagent.com  
