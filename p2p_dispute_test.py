...
class P2PDisputeTest:
    ...
    async def show_frontend_url(self, dispute_id):
        ...
        frontend_url = f"https://crypto-wallet-ui-3.preview.emergentagent.com/admin/disputes/{dispute_id}"
    ...
    async def run_complete_test(self):
        ...
        try:
            ...
            if all_critical_passed:
                ...
                print(f"   https://crypto-wallet-ui-3.preview.emergentagent.com/admin/disputes/{dispute_id}")
