...
Backend URL: https://trade-form-polish.preview.emergentagent.com
"""
...
BACKEND_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://trade-form-polish.preview.emergentagent.com')
