...
# Configuration
BACKEND_URL = "https://tradingbots-ui.preview.emergentagent.com/api"
        ...
        async with session.post(url, json=dispute_data) as response:
            ...
            if response.status == 200:
                ...
                if result.get("success"):
                    ...
                    print(f"   Frontend:  https://tradingbots-ui.preview.emergentagent.com/admin/disputes/{dispute_id}")
