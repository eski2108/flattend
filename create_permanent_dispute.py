...
# Configuration
BACKEND_URL = "https://signal-shield-4.preview.emergentagent.com/api"
        ...
        async with session.post(url, json=dispute_data) as response:
            ...
            if response.status == 200:
                ...
                if result.get("success"):
                    ...
                    print(f"   Frontend:  https://signal-shield-4.preview.emergentagent.com/admin/disputes/{dispute_id}")
