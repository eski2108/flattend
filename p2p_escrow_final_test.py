...
Backend URL: https://wallet-nav-repair.preview.emergentagent.com
"""
...
BACKEND_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://wallet-nav-repair.preview.emergentagent.com')
