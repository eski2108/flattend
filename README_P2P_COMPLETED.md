...
1. **Navigate to:** https://trading-rebuild.preview.emergentagent.com
2. **Login with:**
   - Email: `aby@test.com`
   - Password: `test123`
...
- **Port:** 8001 (internal)
- **External URL:** https://trading-rebuild.preview.emergentagent.com/api
...
# Frontend (.env)
REACT_APP_BACKEND_URL=https://trading-rebuild.preview.emergentagent.com
```
...
**Test URL:** https://trading-rebuild.preview.emergentagent.com  
