...
1. **Navigate to:** https://fixdisputeflow.preview.emergentagent.com
2. **Login with:**
   - Email: `aby@test.com`
   - Password: `test123`
...
- **Port:** 8001 (internal)
- **External URL:** https://fixdisputeflow.preview.emergentagent.com/api
...
# Frontend (.env)
REACT_APP_BACKEND_URL=https://fixdisputeflow.preview.emergentagent.com
```
...
**Test URL:** https://fixdisputeflow.preview.emergentagent.com  
