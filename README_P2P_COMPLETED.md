...
1. **Navigate to:** https://i18n-p2p-fixes.preview.emergentagent.com
2. **Login with:**
   - Email: `aby@test.com`
   - Password: `test123`
...
- **Port:** 8001 (internal)
- **External URL:** https://i18n-p2p-fixes.preview.emergentagent.com/api
...
# Frontend (.env)
REACT_APP_BACKEND_URL=https://i18n-p2p-fixes.preview.emergentagent.com
```
...
**Test URL:** https://i18n-p2p-fixes.preview.emergentagent.com  
