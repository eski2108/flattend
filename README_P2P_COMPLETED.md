...
1. **Navigate to:** https://balance-sync-repair.preview.emergentagent.com
2. **Login with:**
   - Email: `aby@test.com`
   - Password: `test123`
...
- **Port:** 8001 (internal)
- **External URL:** https://balance-sync-repair.preview.emergentagent.com/api
...
**Test URL:** https://balance-sync-repair.preview.emergentagent.com  
