...
- Connected to production backend: `https://trading-perf-boost.preview.emergentagent.com`
...
```bash
curl "https://trading-perf-boost.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
