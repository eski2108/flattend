...
- Connected to production backend: `https://exchange-repair.preview.emergentagent.com`
...
```bash
curl "https://exchange-repair.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
