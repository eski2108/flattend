...
- Connected to production backend: `https://gridbot-app.preview.emergentagent.com`
...
```bash
curl "https://gridbot-app.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
