...
- Connected to production backend: `https://controlpanel-4.preview.emergentagent.com`
...
```bash
curl "https://controlpanel-4.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
