...
- Connected to production backend: `https://crypto-wallet-ui-3.preview.emergentagent.com`
...
```bash
curl "https://crypto-wallet-ui-3.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
