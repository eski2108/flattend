...
- Connected to production backend: `https://cryptolaunch-9.preview.emergentagent.com`
...
```bash
curl "https://cryptolaunch-9.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
