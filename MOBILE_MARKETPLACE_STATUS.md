...
- Connected to production backend: `https://marketview-36.preview.emergentagent.com`
...
```bash
curl "https://marketview-36.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
