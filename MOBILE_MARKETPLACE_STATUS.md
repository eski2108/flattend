...
- Connected to production backend: `https://crypto-2fa-update.preview.emergentagent.com`
...
```bash
curl "https://crypto-2fa-update.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
