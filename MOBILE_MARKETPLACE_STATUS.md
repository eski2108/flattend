...
- Connected to production backend: `https://p2ptrade-1.preview.emergentagent.com`
...
```bash
curl "https://p2ptrade-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
