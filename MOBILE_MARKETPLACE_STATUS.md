...
- Connected to production backend: `https://wallet-nav-repair.preview.emergentagent.com`
...
```bash
curl "https://wallet-nav-repair.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
