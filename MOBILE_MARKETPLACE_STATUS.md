...
- Connected to production backend: `https://crypto-validator.preview.emergentagent.com`
...
```bash
curl "https://crypto-validator.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
