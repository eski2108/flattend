...
- Connected to production backend: `https://p2pcryptomarket.preview.emergentagent.com`
...
```bash
curl "https://p2pcryptomarket.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
