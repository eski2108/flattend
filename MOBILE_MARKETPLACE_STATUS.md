...
- Connected to production backend: `https://quickstart-27.preview.emergentagent.com`
...
```bash
curl "https://quickstart-27.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
