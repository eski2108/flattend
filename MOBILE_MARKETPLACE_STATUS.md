...
- Connected to production backend: `https://coinhubuix.preview.emergentagent.com`
...
```bash
curl "https://coinhubuix.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
