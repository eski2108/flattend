...
- Connected to production backend: `https://atomic-pay-fix.preview.emergentagent.com`
...
```bash
curl "https://atomic-pay-fix.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
