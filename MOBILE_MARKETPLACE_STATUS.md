...
- Connected to production backend: `https://coinhubx-ui-refresh.preview.emergentagent.com`
...
```bash
curl "https://coinhubx-ui-refresh.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
