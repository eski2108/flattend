...
- Connected to production backend: `https://savingsflow-1.preview.emergentagent.com`
...
```bash
curl "https://savingsflow-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
