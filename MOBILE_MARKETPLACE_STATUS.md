...
- Connected to production backend: `https://layout-restore-2.preview.emergentagent.com`
...
```bash
curl "https://layout-restore-2.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
