...
- Connected to production backend: `https://fixdisputeflow.preview.emergentagent.com`
...
```bash
curl "https://fixdisputeflow.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
