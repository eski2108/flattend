...
- Connected to production backend: `https://tradewatch-13.preview.emergentagent.com`
...
```bash
curl "https://tradewatch-13.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
