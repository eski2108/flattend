...
- Connected to production backend: `https://trading-rebuild.preview.emergentagent.com`
...
```bash
curl "https://trading-rebuild.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
