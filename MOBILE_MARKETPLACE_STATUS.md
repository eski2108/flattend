...
- Connected to production backend: `https://money-trail-4.preview.emergentagent.com`
...
```bash
curl "https://money-trail-4.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
