...
- Connected to production backend: `https://crypto-hub-xchange.preview.emergentagent.com`
...
```bash
curl "https://crypto-hub-xchange.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
