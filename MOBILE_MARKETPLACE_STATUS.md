...
- Connected to production backend: `https://tradepanel-12.preview.emergentagent.com`
...
```bash
curl "https://tradepanel-12.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
