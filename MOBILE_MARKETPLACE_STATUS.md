...
- Connected to production backend: `https://nowpay-debug.preview.emergentagent.com`
...
```bash
curl "https://nowpay-debug.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
