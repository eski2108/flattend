...
- Connected to production backend: `https://neon-finance-5.preview.emergentagent.com`
...
```bash
curl "https://neon-finance-5.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
