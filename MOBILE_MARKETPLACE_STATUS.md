...
- Connected to production backend: `https://cryptodash-22.preview.emergentagent.com`
...
```bash
curl "https://cryptodash-22.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
