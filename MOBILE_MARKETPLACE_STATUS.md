...
- Connected to production backend: `https://finflowfix.preview.emergentagent.com`
...
```bash
curl "https://finflowfix.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
