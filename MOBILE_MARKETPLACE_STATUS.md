...
- Connected to production backend: `https://fund-release-1.preview.emergentagent.com`
...
```bash
curl "https://fund-release-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
