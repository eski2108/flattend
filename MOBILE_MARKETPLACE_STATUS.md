...
- Connected to production backend: `https://balance-sync-repair.preview.emergentagent.com`
...
```bash
curl "https://balance-sync-repair.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
