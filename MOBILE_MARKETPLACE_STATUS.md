...
- Connected to production backend: `https://earn-rewards-21.preview.emergentagent.com`
...
```bash
curl "https://earn-rewards-21.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
