...
- Connected to production backend: `https://crypto-finalize.preview.emergentagent.com`
...
```bash
curl "https://crypto-finalize.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
