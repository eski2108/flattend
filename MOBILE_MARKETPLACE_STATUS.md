...
- Connected to production backend: `https://premium-wallet-hub.preview.emergentagent.com`
...
```bash
curl "https://premium-wallet-hub.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
