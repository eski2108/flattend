...
- Connected to production backend: `https://signal-shield-4.preview.emergentagent.com`
...
```bash
curl "https://signal-shield-4.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
