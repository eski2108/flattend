...
- Connected to production backend: `https://savings-app-12.preview.emergentagent.com`
...
```bash
curl "https://savings-app-12.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
