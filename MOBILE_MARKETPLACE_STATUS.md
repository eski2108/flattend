...
- Connected to production backend: `https://tradingbot-hub-13.preview.emergentagent.com`
...
```bash
curl "https://tradingbot-hub-13.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
