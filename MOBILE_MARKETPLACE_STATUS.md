...
- Connected to production backend: `https://order-confirmation-2.preview.emergentagent.com`
...
```bash
curl "https://order-confirmation-2.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
