...
- Connected to production backend: `https://crypto-trust-guard.preview.emergentagent.com`
...
```bash
curl "https://crypto-trust-guard.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
