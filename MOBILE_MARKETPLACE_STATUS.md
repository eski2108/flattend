...
- Connected to production backend: `https://signx-repair.preview.emergentagent.com`
...
```bash
curl "https://signx-repair.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
