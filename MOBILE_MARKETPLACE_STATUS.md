...
- Connected to production backend: `https://crypto-logo-update.preview.emergentagent.com`
...
```bash
curl "https://crypto-logo-update.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
