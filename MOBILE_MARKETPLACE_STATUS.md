...
- Connected to production backend: `https://walletfix.preview.emergentagent.com`
...
```bash
curl "https://walletfix.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
