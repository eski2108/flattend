...
- Connected to production backend: `https://cryptodash-17.preview.emergentagent.com`
...
```bash
curl "https://cryptodash-17.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
