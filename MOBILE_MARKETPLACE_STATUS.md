...
- Connected to production backend: `https://coinhub-rescue.preview.emergentagent.com`
...
```bash
curl "https://coinhub-rescue.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
