...
- Connected to production backend: `https://payflow-crypto-3.preview.emergentagent.com`
...
```bash
curl "https://payflow-crypto-3.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
