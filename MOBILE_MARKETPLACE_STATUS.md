...
- Connected to production backend: `https://pixelperfect-trade.preview.emergentagent.com`
...
```bash
curl "https://pixelperfect-trade.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
