...
- Connected to production backend: `https://trade-master-126.preview.emergentagent.com`
...
```bash
curl "https://trade-master-126.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
