...
- Connected to production backend: `https://musing-brown-1.preview.emergentagent.com`
...
```bash
curl "https://musing-brown-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
