...
- Connected to production backend: `https://fee-central.preview.emergentagent.com`
...
```bash
curl "https://fee-central.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
