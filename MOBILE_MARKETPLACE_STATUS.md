...
- Connected to production backend: `https://cryptoex-preview-1.preview.emergentagent.com`
...
```bash
curl "https://cryptoex-preview-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
