...
- Connected to production backend: `https://crypto-exchange-hub-12.preview.emergentagent.com`
...
```bash
curl "https://crypto-exchange-hub-12.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
