...
- Connected to production backend: `https://botengine.preview.emergentagent.com`
...
```bash
curl "https://botengine.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
