...
- Connected to production backend: `https://monitorcrypto.preview.emergentagent.com`
...
```bash
curl "https://monitorcrypto.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
