...
- Connected to production backend: `https://unified-trading-1.preview.emergentagent.com`
...
```bash
curl "https://unified-trading-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
