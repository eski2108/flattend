...
- Connected to production backend: `https://trade-form-polish.preview.emergentagent.com`
...
```bash
curl "https://trade-form-polish.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
