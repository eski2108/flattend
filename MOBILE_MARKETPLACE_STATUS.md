...
- Connected to production backend: `https://savingsflow.preview.emergentagent.com`
...
```bash
curl "https://savingsflow.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
