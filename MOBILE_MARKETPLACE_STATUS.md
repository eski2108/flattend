...
- Connected to production backend: `https://fee-analytics.preview.emergentagent.com`
...
```bash
curl "https://fee-analytics.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
