...
- Connected to production backend: `https://tradingbots-ui.preview.emergentagent.com`
...
```bash
curl "https://tradingbots-ui.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
