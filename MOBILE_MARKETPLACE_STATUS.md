...
- Connected to production backend: `https://finance-check-5.preview.emergentagent.com`
...
```bash
curl "https://finance-check-5.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
