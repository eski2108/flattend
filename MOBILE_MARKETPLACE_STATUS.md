...
- Connected to production backend: `https://neon-vault-1.preview.emergentagent.com`
...
```bash
curl "https://neon-vault-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
