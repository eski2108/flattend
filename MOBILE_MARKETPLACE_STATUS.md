...
- Connected to production backend: `https://bugsecurehub.preview.emergentagent.com`
...
```bash
curl "https://bugsecurehub.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
