...
- Connected to production backend: `https://crypto-fixbugs.preview.emergentagent.com`
...
```bash
curl "https://crypto-fixbugs.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
