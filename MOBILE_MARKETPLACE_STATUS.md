...
- Connected to production backend: `https://crypto-alert-hub-2.preview.emergentagent.com`
...
```bash
curl "https://crypto-alert-hub-2.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
