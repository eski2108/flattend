...
- Connected to production backend: `https://tradehub-268.preview.emergentagent.com`
...
```bash
curl "https://tradehub-268.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
