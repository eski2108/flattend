...
- Connected to production backend: `https://crypto-exchange-fix.preview.emergentagent.com`
...
```bash
curl "https://crypto-exchange-fix.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
