...
- Connected to production backend: `https://protrading.preview.emergentagent.com`
...
```bash
curl "https://protrading.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
