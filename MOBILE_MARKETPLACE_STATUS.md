...
- Connected to production backend: `https://coin-icon-fixer.preview.emergentagent.com`
...
```bash
curl "https://coin-icon-fixer.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
