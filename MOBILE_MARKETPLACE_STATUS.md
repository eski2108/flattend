...
- Connected to production backend: `https://tradinghub-7.preview.emergentagent.com`
...
```bash
curl "https://tradinghub-7.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
