...
- Connected to production backend: `https://coinhubxrepo.preview.emergentagent.com`
...
```bash
curl "https://coinhubxrepo.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
