...
- Connected to production backend: `https://crypto-integrify.preview.emergentagent.com`
...
```bash
curl "https://crypto-integrify.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
