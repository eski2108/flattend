...
- Connected to production backend: `https://crypto-botui.preview.emergentagent.com`
...
```bash
curl "https://crypto-botui.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
