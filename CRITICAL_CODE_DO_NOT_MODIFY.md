...
curl https://exchange-repair.preview.emergentagent.com/api/wallet/balance/test_user_123/BTC

# 2. Test P2P offers listing
curl https://exchange-repair.preview.emergentagent.com/api/p2p/offers?ad_type=sell&crypto_currency=BTC
...
1. Check wallet service endpoints are accessible:
   ```bash
   curl https://exchange-repair.preview.emergentagent.com/api/wallet/balance/test_user/BTC
   ```
