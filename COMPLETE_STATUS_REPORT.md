...
**How to Test**:
1. Login at: https://monitorcrypto.preview.emergentagent.com/login
2. Navigate to: https://monitorcrypto.preview.emergentagent.com/2fa-setup
3. Click "Enable 2FA"
...
- ✅ Frontend URL: `https://monitorcrypto.preview.emergentagent.com`
...
4. Add this Authorized Redirect URI:
   ```
   https://monitorcrypto.preview.emergentagent.com/api/auth/google/callback
   ```
5. Save changes
...
1. **Login System** ✅
   - URL: https://monitorcrypto.preview.emergentagent.com/login
...
3. **2FA Setup** ✅
   - URL: https://monitorcrypto.preview.emergentagent.com/2fa-setup
   - Enable 2FA and test with Google Authenticator

4. **Trading Page** ⚠️
   - URL: https://monitorcrypto.preview.emergentagent.com/trading
   - View charts and UI (order placement may need fixing)

5. **P2P Express** ⚠️
   - URL: https://monitorcrypto.preview.emergentagent.com/instant-buy
...
**Environment**: https://monitorcrypto.preview.emergentagent.com
