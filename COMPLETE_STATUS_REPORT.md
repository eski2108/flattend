...
**How to Test**:
1. Login at: https://balance-sync-repair.preview.emergentagent.com/login
2. Navigate to: https://balance-sync-repair.preview.emergentagent.com/2fa-setup
3. Click "Enable 2FA"
...
- ✅ Frontend URL: `https://balance-sync-repair.preview.emergentagent.com`
...
4. Add this Authorized Redirect URI:
   ```
   https://balance-sync-repair.preview.emergentagent.com/api/auth/google/callback
   ```
5. Save changes
...
1. **Login System** ✅
   - URL: https://balance-sync-repair.preview.emergentagent.com/login
...
3. **2FA Setup** ✅
   - URL: https://balance-sync-repair.preview.emergentagent.com/2fa-setup
...
5. **P2P Express** ⚠️
   - URL: https://balance-sync-repair.preview.emergentagent.com/instant-buy
