...
2. Navigate to: https://crypto-trust-guard.preview.emergentagent.com/2fa-setup
3. Click "Enable 2FA"
...
- ✅ Frontend URL: `https://crypto-trust-guard.preview.emergentagent.com`
...
4. Add this Authorized Redirect URI:
   ```
   https://crypto-trust-guard.preview.emergentagent.com/api/auth/google/callback
   ```
5. Save changes
...
1. **Login System** ✅
   - URL: https://crypto-trust-guard.preview.emergentagent.com/login
...
3. **2FA Setup** ✅
   - URL: https://crypto-trust-guard.preview.emergentagent.com/2fa-setup
...
5. **P2P Express** ⚠️
   - URL: https://crypto-trust-guard.preview.emergentagent.com/instant-buy
...
**Environment**: https://crypto-trust-guard.preview.emergentagent.com
