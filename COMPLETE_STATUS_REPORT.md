...
2. Navigate to: https://atomic-pay-fix.preview.emergentagent.com/2fa-setup
3. Click "Enable 2FA"
...
- ✅ Frontend URL: `https://atomic-pay-fix.preview.emergentagent.com`
...
4. Add this Authorized Redirect URI:
   ```
   https://atomic-pay-fix.preview.emergentagent.com/api/auth/google/callback
   ```
5. Save changes
...
1. **Login System** ✅
   - URL: https://atomic-pay-fix.preview.emergentagent.com/login
...
3. **2FA Setup** ✅
   - URL: https://atomic-pay-fix.preview.emergentagent.com/2fa-setup
...
5. **P2P Express** ⚠️
   - URL: https://atomic-pay-fix.preview.emergentagent.com/instant-buy
...
**Environment**: https://atomic-pay-fix.preview.emergentagent.com
