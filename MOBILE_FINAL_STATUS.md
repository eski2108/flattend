...
### API Test:
```bash
curl https://finance-check-5.preview.emergentagent.com/api/user/referral-dashboard/9757bd8c-16f8-4efb-b075-0af4a432990a
```
...
```json
{
  ...
  "data": {
    ...
    "referral_link": "https://finance-check-5.preview.emergentagent.com/register?ref=HZZCUVHF",
    "total_referrals": 0,
    "active_referrals": 0,
    "total_earnings": 0,
    "pending_earnings": 0,
