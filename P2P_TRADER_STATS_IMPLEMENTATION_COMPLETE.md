...
curl -X GET "https://order-confirmation-2.preview.emergentagent.com/api/trader/stats/user_123abc"

# Test with non-existent user (should return zeros)
curl -X GET "https://order-confirmation-2.preview.emergentagent.com/api/trader/stats/nonexistent"
```
