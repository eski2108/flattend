                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="center" bgcolor="#EF4444" style="border-radius: 8px;">
                                            <a href="https://finance-check-5.preview.emergentagent.com/#/admin/disputes/{dispute_id}" 
                                               target="_blank"
                    ...
                    <div style="background: #FEF3C7; border: 2px solid #F59E0B; padding: 20px; border-radius: 8px; margin-top: 20px;">
                        ...
                        <div style="background: white; padding: 12px; border-radius: 6px; border: 1px solid #D97706;">
                            <p style="margin: 0; font-size: 13px; color: #1F2937; word-break: break-all; text-align: center; font-family: monospace;">
                                https://finance-check-5.preview.emergentagent.com/#/admin/disputes/{dispute_id}
                            </p>
                        </div>
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; padding: 20px; background: #f9fafb; border-radius: 12px;">
                    ...
                    <div style="background: white; padding: 25px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                        ...
                        <div style="text-align: center; margin: 30px 0;">
                            <a href="https://finance-check-5.preview.emergentagent.com/admin/disputes/{order_id}" style="display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #00F0FF, #A855F7); color: #000; text-decoration: none; border-radius: 8px; font-weight: 700; font-size: 16px;">
                                View Dispute →
                            </a>
                        </div>
...
def p2p_payment_marked_email(trade_id: str, crypto_amount: float, crypto: str, fiat_amount: float, buyer_username: str):
    ...
    <body style="font-family: Arial, sans-serif; background-color: #0A1929; color: #FFFFFF; padding: 20px;">
        <div style="max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #051018 0%, #0A1929 100%); border: 1px solid #00C6FF; border-radius: 12px; padding: 30px;">
            ...
            <a href="https://finance-check-5.preview.emergentagent.com/p2p/order/{trade_id}" 
    ...
    <body style="font-family: Arial, sans-serif; background-color: #0A1929; color: #FFFFFF; padding: 20px;">
        <div style="max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #051018 0%, #0A1929 100%); border: 1px solid #EF4444; border-radius: 12px; padding: 30px;">
            ...
            <p style="margin-top: 20px; font-size: 13px; color: #8F9BB3; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 15px;">
                ...
                <a href="https://finance-check-5.preview.emergentagent.com/p2p/order/{trade_id}" style="color: #00F0FF; word-break: break-all;">
                    https://finance-check-5.preview.emergentagent.com/p2p/order/{trade_id}
                </a>
            </p>
...
def p2p_admin_dispute_alert(trade_id: str, dispute_id: str, crypto_amount: float, crypto: str, buyer_id: str, seller_id: str, reported_by: str):
    ...
    frontend_url = 'https://finance-check-5.preview.emergentagent.com'
