...
def get_frontend_url():
    ...
    return os.environ.get('FRONTEND_URL') or os.environ.get('BACKEND_URL') or os.environ.get('REACT_APP_BACKEND_URL') or 'https://balance-sync-repair.preview.emergentagent.com'
