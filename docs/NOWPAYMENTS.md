...
BACKEND_URL=https://signal-shield-4.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://signal-shield-4.preview.emergentagent.com/api/nowpayments/ipn`
