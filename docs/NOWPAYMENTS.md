...
BACKEND_URL=https://dual-currency-crypto.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://dual-currency-crypto.preview.emergentagent.com/api/nowpayments/ipn`
