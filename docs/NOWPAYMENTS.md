...
BACKEND_URL=https://p2pcryptomarket.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://p2pcryptomarket.preview.emergentagent.com/api/nowpayments/ipn`
