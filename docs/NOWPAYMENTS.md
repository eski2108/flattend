...
BACKEND_URL=https://pixelperfect-trade.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://pixelperfect-trade.preview.emergentagent.com/api/nowpayments/ipn`
