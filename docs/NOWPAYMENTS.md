...
BACKEND_URL=https://payflow-crypto-3.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://payflow-crypto-3.preview.emergentagent.com/api/nowpayments/ipn`
