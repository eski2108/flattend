...
BACKEND_URL=https://exchange-repair.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://exchange-repair.preview.emergentagent.com/api/nowpayments/ipn`
