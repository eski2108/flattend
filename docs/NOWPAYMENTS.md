...
BACKEND_URL=https://crypto-hub-xchange.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://crypto-hub-xchange.preview.emergentagent.com/api/nowpayments/ipn`
