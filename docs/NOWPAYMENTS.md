...
BACKEND_URL=https://cryptoex-preview-1.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://cryptoex-preview-1.preview.emergentagent.com/api/nowpayments/ipn`
