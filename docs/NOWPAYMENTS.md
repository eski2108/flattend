...
BACKEND_URL=https://crypto-exchange-fix.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://crypto-exchange-fix.preview.emergentagent.com/api/nowpayments/ipn`
