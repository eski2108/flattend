...
BACKEND_URL=https://fixdisputeflow.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://fixdisputeflow.preview.emergentagent.com/api/nowpayments/ipn`
