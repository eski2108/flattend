...
BACKEND_URL=https://crypto-finalize.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://crypto-finalize.preview.emergentagent.com/api/nowpayments/ipn`
