...
BACKEND_URL=https://tradeliquidity.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://tradeliquidity.preview.emergentagent.com/api/nowpayments/ipn`
