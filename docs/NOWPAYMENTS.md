...
BACKEND_URL=https://musing-brown-1.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://musing-brown-1.preview.emergentagent.com/api/nowpayments/ipn`
