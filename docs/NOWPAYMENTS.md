...
BACKEND_URL=https://coinhubx-ui-refresh.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://coinhubx-ui-refresh.preview.emergentagent.com/api/nowpayments/ipn`
