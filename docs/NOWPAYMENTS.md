...
BACKEND_URL=https://finance-check-5.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://finance-check-5.preview.emergentagent.com/api/nowpayments/ipn`
