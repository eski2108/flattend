...
BACKEND_URL=https://p2p-trading-hub.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://p2p-trading-hub.preview.emergentagent.com/api/nowpayments/ipn`
