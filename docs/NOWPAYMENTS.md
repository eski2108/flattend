...
BACKEND_URL=https://crypto-fixbugs.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://crypto-fixbugs.preview.emergentagent.com/api/nowpayments/ipn`
