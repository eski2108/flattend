...
BACKEND_URL=https://cryptosupport-1.preview.emergentagent.com
```
...
3. Set IPN callback URL to: `https://cryptosupport-1.preview.emergentagent.com/api/nowpayments/ipn`
