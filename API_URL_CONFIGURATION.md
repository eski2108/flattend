...
**`/app/frontend/.env`:**
```
REACT_APP_BACKEND_URL=https://coinhubx-ui-refresh.preview.emergentagent.com
```
...
```bash
# Test login
curl -X POST https://coinhubx-ui-refresh.preview.emergentagent.com/api/auth/login \
