...
**`/app/frontend/.env`:**
```
REACT_APP_BACKEND_URL=https://crypto-exchange-159.preview.emergentagent.com
```
...
```bash
# Test login
curl -X POST https://crypto-exchange-159.preview.emergentagent.com/api/auth/login \
