...
curl -X POST https://tradefix-preview.preview.emergentagent.com/api/wallet/withdraw \
...
// Try swap
curl -X POST https://tradefix-preview.preview.emergentagent.com/api/swap/execute \
  -H "Content-Type: application/json" \
  -d '{
    "user_id": "test_user",
    "from_currency": "BTC",
