...
**URL:** `https://savings-app-12.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://savings-app-12.preview.emergentagent.com/api/admin/liquidity-all`
