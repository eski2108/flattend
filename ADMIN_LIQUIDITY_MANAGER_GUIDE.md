...
**URL:** `https://spottrading-fix.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://spottrading-fix.preview.emergentagent.com/api/admin/liquidity-all`
