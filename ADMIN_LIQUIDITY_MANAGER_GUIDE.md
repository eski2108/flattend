...
**URL:** `https://trade-master-126.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://trade-master-126.preview.emergentagent.com/api/admin/liquidity-all`
