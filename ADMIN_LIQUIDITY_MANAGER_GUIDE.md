...
**URL:** `https://monitorcrypto.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://monitorcrypto.preview.emergentagent.com/api/admin/liquidity-all`
