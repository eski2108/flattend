...
**URL:** `https://crypto-botui.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://crypto-botui.preview.emergentagent.com/api/admin/liquidity-all`
