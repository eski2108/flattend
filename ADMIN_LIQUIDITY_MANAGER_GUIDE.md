...
**URL:** `https://coinfix.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://coinfix.preview.emergentagent.com/api/admin/liquidity-all`
