...
**URL:** `https://finance-check-5.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://finance-check-5.preview.emergentagent.com/api/admin/liquidity-all`
