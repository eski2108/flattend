...
**URL:** `https://coin-icon-fixer.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://coin-icon-fixer.preview.emergentagent.com/api/admin/liquidity-all`
