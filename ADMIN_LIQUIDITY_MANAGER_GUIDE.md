...
**URL:** `https://savingsflow.preview.emergentagent.com/admin/liquidity-manager`
...
- Check API endpoint: `curl https://savingsflow.preview.emergentagent.com/api/admin/liquidity-all`
