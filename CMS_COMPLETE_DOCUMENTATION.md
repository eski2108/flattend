...
```bash
curl -X PUT https://trade-form-polish.preview.emergentagent.com/api/cms/settings/fees \
...
```bash
curl -X PUT https://trade-form-polish.preview.emergentagent.com/api/cms/settings/marketplace-visibility \
  -H "Content-Type: application/json" \
...
```bash
curl -X PUT https://trade-form-polish.preview.emergentagent.com/api/cms/settings/display \
  -H "Content-Type: application/json" \
  -d '{"sort_by": "rating"}'
```
...
```bash
curl -X PUT https://trade-form-polish.preview.emergentagent.com/api/cms/settings/seller-limits \
  -H "Content-Type: application/json" \
