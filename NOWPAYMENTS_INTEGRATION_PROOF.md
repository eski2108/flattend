...
**Live Test Proof:**
```bash
$ curl "https://trade-form-polish.preview.emergentagent.com/api/wallet/send/BTC/metadata?user_id=test"
{
  "success": true,
  "currency": "BTC",
  "available_balance": 0,
...
**Live Test Proof:**
```bash
$ curl "https://trade-form-polish.preview.emergentagent.com/api/crypto-bank/deposit-address/btc"
{
  "success": true,
  "currency": "BTC",
...
**Live Test Proof:**
```bash
$ curl "https://trade-form-polish.preview.emergentagent.com/api/swap/available-coins"
{
  "success": true,
...
**Live Test Proof:**
```bash
$ curl "https://trade-form-polish.preview.emergentagent.com/api/crypto-market/sell/orders"
{
  "success": true,
  "orders": []
}
...
```bash
$ curl "https://trade-form-polish.preview.emergentagent.com/api/crypto-bank/deposit-address/eth"
```
**Result:** ✅ Returns REAL Ethereum address from NowPayments

### Test 2: Send Metadata
```bash
$ curl "https://trade-form-polish.preview.emergentagent.com/api/wallet/send/ETH/metadata?user_id=test"
```
