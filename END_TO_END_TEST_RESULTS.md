...
### **Dispute Link:**
```
https://crypto-botui.preview.emergentagent.com/admin/disputes/dispute_40e60813ad5e
```
...
```bash
curl "https://crypto-botui.preview.emergentagent.com/api/trader/stats/test_buyer_d07e8c39" | python3 -m json.tool
```
...
```bash
curl "https://crypto-botui.preview.emergentagent.com/api/trader/stats/test_seller_1d9a79d9" | python3 -m json.tool
```
...
**Dispute Link:** `https://crypto-botui.preview.emergentagent.com/admin/disputes/dispute_40e60813ad5e`
