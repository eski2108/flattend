...
**Admin Panel URL:**
```
https://musing-brown-1.preview.emergentagent.com/admin/login
```

**How to Create Your Admin Account:**

1. **First, Register a Regular Account:**
   - Go to: https://musing-brown-1.preview.emergentagent.com/register
...
**Desktop:** https://musing-brown-1.preview.emergentagent.com/admin/login
