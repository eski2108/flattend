...
**Admin Panel URL:**
```
https://p2p-repair-1.preview.emergentagent.com/admin/login
```

**How to Create Your Admin Account:**

1. **First, Register a Regular Account:**
   - Go to: https://p2p-repair-1.preview.emergentagent.com/register
   - Use YOUR email (e.g., admin@coinhubx.com)
   - Choose a strong password
   - Complete registration

2. **Then Login as Admin:**
   - Go to: https://p2p-repair-1.preview.emergentagent.com/admin/login
   - Enter your email
   - Enter your password
...
**Desktop:** https://p2p-repair-1.preview.emergentagent.com/admin/login
