...
```bash
# Presets endpoint
curl https://unified-trading-1.preview.emergentagent.com/api/bots/presets
# Returns 8 presets

# Backtest endpoint
curl -X POST https://unified-trading-1.preview.emergentagent.com/api/bots/backtest \
