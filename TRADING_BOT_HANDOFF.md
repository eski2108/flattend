...
```bash
# Presets endpoint
curl https://tradingbot-hub-13.preview.emergentagent.com/api/bots/presets
# Returns 8 presets

# Backtest endpoint
curl -X POST https://tradingbot-hub-13.preview.emergentagent.com/api/bots/backtest \
