...
- ✅ API Base URL: `https://earn-rewards-21.preview.emergentagent.com`
...
2. Verify API URL is correct: `https://earn-rewards-21.preview.emergentagent.com`
...
### API Endpoint Test:
```bash
curl -X POST https://earn-rewards-21.preview.emergentagent.com/api/auth/login \
