...
- ✅ API Base URL: `https://nowpay-debug.preview.emergentagent.com`
...
2. Verify API URL is correct: `https://nowpay-debug.preview.emergentagent.com`
...
### API Endpoint Test:
```bash
curl -X POST https://nowpay-debug.preview.emergentagent.com/api/auth/login \
