...
- ✅ API Base URL: `https://cryptolaunch-9.preview.emergentagent.com`
...
2. Verify API URL is correct: `https://cryptolaunch-9.preview.emergentagent.com`
...
### API Endpoint Test:
```bash
curl -X POST https://cryptolaunch-9.preview.emergentagent.com/api/auth/login \
