...
- ✅ API Base URL: `https://crypto-trust-guard.preview.emergentagent.com`
...
2. Verify API URL is correct: `https://crypto-trust-guard.preview.emergentagent.com`
...
### API Endpoint Test:
```bash
curl -X POST https://crypto-trust-guard.preview.emergentagent.com/api/auth/login \
