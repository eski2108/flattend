...
**API Call:**
```bash
curl -X POST "https://nowpay-debug.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://nowpay-debug.preview.emergentagent.com` or different?
