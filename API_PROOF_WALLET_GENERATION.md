...
**API Call:**
```bash
curl -X POST "https://multilingual-crypto-2.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://multilingual-crypto-2.preview.emergentagent.com` or different?
