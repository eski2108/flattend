...
**API Call:**
```bash
curl -X POST "https://finance-check-5.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://finance-check-5.preview.emergentagent.com` or different?
