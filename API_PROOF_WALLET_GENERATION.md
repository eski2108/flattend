...
**API Call:**
```bash
curl -X POST "https://tradingbot-hub-13.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://tradingbot-hub-13.preview.emergentagent.com` or different?
