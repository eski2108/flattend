...
**API Call:**
```bash
curl -X POST "https://pixelperfect-trade.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://pixelperfect-trade.preview.emergentagent.com` or different?
