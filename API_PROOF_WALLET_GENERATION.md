...
**API Call:**
```bash
curl -X POST "https://premium-wallet-hub.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://premium-wallet-hub.preview.emergentagent.com` or different?
