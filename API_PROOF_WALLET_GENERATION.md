...
**API Call:**
```bash
curl -X POST "https://coinhub-rescue.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://coinhub-rescue.preview.emergentagent.com` or different?
