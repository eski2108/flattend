...
**API Call:**
```bash
curl -X POST "https://layout-restore-2.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://layout-restore-2.preview.emergentagent.com` or different?
