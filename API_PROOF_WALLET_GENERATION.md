...
**API Call:**
```bash
curl -X POST "https://coin-icon-fixer.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://coin-icon-fixer.preview.emergentagent.com` or different?
