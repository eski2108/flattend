...
**API Call:**
```bash
curl -X POST "https://bugsecurehub.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://bugsecurehub.preview.emergentagent.com` or different?
