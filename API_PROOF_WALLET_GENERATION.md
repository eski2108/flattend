...
**API Call:**
```bash
curl -X POST "https://money-trail-4.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://money-trail-4.preview.emergentagent.com` or different?
