...
**API Call:**
```bash
curl -X POST "https://crypto-integrify.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://crypto-integrify.preview.emergentagent.com` or different?
