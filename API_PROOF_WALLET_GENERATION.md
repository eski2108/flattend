...
**API Call:**
```bash
curl -X POST "https://savings-app-12.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://savings-app-12.preview.emergentagent.com` or different?
