...
**API Call:**
```bash
curl -X POST "https://earn-rewards-21.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://earn-rewards-21.preview.emergentagent.com` or different?
