...
**API Call:**
```bash
curl -X POST "https://binancelike-ui.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://binancelike-ui.preview.emergentagent.com` or different?
