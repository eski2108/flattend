...
**API Call:**
```bash
curl -X POST "https://trading-rebuild.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://trading-rebuild.preview.emergentagent.com` or different?
