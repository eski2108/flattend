...
**API Call:**
```bash
curl -X POST "https://trade-master-126.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://trade-master-126.preview.emergentagent.com` or different?
