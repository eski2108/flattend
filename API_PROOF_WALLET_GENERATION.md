...
**API Call:**
```bash
curl -X POST "https://atomic-pay-fix.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://atomic-pay-fix.preview.emergentagent.com` or different?
