...
**API Call:**
```bash
curl -X POST "https://balance-sync-repair.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://balance-sync-repair.preview.emergentagent.com` or different?
