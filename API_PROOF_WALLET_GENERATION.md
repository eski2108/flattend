...
**API Call:**
```bash
curl -X POST "https://tradehub-268.preview.emergentagent.com/api/nowpayments/create-deposit" \
...
1. **Confirm your EXACT preview URL** - is it `https://tradehub-268.preview.emergentagent.com` or different?
