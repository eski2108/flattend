...
import { ArrowRight, CreditCard, DollarSign, Lock, Users } from 'react-icons/io5';
import { IoFlash as Zap, IoShield as Shield, IoTrendingUp as TrendingUp } from 'react-icons/io5';
            ...
            <button
              onClick={() => {
                ...
                if (isIOS) {
                  ...
                  window.open('https://crypto-finalize.preview.emergentagent.com', '_blank');
                }
              }}
              style={{
                position: 'relative',
