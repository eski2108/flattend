  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Box 1: Last Price - CYAN (less bright) */}
        <div style={{
          background: 'linear-gradient(180deg, rgba(0, 212, 255, 0.03) 0%, rgba(0, 212, 255, 0.15) 100%)',
        ...
        {/* Box 2: 24h Change - RED (less bright) */}
        <div style={{
        ...
        {/* Box 3: 24h High - PURPLE (less bright) */}
        <div style={{
          background: 'linear-gradient(180deg, rgba(168, 85, 247, 0.03) 0%, rgba(168, 85, 247, 0.15) 100%)',
        ...
        {/* Box 4: 24h Low - YELLOW (less bright) */}
        <div style={{
          background: 'linear-gradient(180deg, rgba(250, 204, 21, 0.03) 0%, rgba(250, 204, 21, 0.15) 100%)',
          ...
          <div style={{
            ...
            height: '3px',
            background: '#facc15',
            boxShadow: '0 0 15px #facc15, 0 0 30px #facc15',
            filter: 'blur(2px)'
          }}></div>
