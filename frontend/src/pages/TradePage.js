...
import { IoShield, IoTime, IoChatbubbles, IoSend, IoCheckmarkCircle, IoCloseCircle, IoArrowBack, IoWallet, IoCopy } from 'react-icons/io5';;
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
          ...
          <div>
            ...
            <Card style={{ background: 'rgba(26, 31, 58, 0.8)', border: '1px solid rgba(0, 240, 255, 0.2)', borderRadius: '16px', padding: '2rem', marginBottom: '2rem' }}>
              ...
              {[
                { label: 'Amount', value: trade?.crypto_currency && trade?.crypto_amount ? `${getCryptoEmoji(trade.crypto_currency)} ${trade.crypto_amount} ${trade.crypto_currency}` : 'N/A' },
