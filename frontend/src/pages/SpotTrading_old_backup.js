...
import { Activity, ChevronDown, DollarSign, IoFlash as Zap, IoTime as Clock, IoTrendingDown as TrendingDown, IoTrendingUp as TrendingUp, TrendingDown, TrendingUp, Zap } from 'react-icons/io5';
...
export default function SpotTrading() {
  ...
  }, [selectedPair, timeframe, tradingPairs]);
  ...
  const generateRecentTrades = (price) => {
    ...
    for (let i = 0; i < 20; i++) {
      trades.push({
        ...
        time: new Date(time - i * 10000).toLocaleTimeString(),
  ...
  const handleTrade = async (fromModal = false) => {
    ...
    try {
      ...
      // Log to backend as "Trading" revenue
      await axios.post(`${API}/api/trading/log-trade`, {
        ...
        fee: feeAmount,
        source: 'spot_trading'
      }).catch(err => console.log('Trade logging error:', err));
  ...
  return (
    <Layout>
      <div style={{ padding: '1rem', background: '#0a0e1a' }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem' }}>
              <div>
                <div style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.5)' }}>Last Price</div>
        ...
        {/* Main Trading Layout */}
        <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr 380px', gap: '1.5rem', minHeight: '600px' }}>
          {/* Left: Order Book */}
          <div style={{
            ...
            <div style={{
              ...
              <div ref={chartContainerRef} style={{ 
                ...
                <div style={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
                  <div style={{ fontSize: '1.5rem', color: '#00F0FF', fontWeight: '700', marginBottom: '0.5rem' }}>
                    £{marketStats.lastPrice.toLocaleString()}
                  </div>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1.125rem', fontWeight: '700', color: '#fff', marginBottom: '1.5rem' }}>
              Spot Trading
            </h3>
            ...
            {amount && parseFloat(amount) > 0 && (
              <div style={{
                ...
                <div style={{ fontSize: '1.25rem', fontWeight: '700', color: '#00F0FF' }}>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <div style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                    ...
                    <span style={{ fontWeight: '700', color: '#fff', fontSize: '1.125rem' }}>
                      {selectedPairData?.icon} {selectedPair}
                    </span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                    <span style={{ color: 'rgba(255,255,255,0.7)' }}>Current Price:</span>
                    <span style={{ fontWeight: '700', color: '#00F0FF', fontSize: '1.125rem' }}>
                      £{marketStats.lastPrice.toLocaleString()}
                    </span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '0.85rem', color: '#22C55E', lineHeight: '1.5' }}>
