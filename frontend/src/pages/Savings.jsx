...
// All supported coins - ALWAYS VISIBLE regardless of balance
const ALL_SUPPORTED_COINS = [
  ...
  { code: 'BNB', name: 'Binance Coin', icon: 'B', color: '#F3BA2F', gradient: 'from-yellow-400 to-orange-500' },
  { code: 'SOL', name: 'Solana', icon: 'S', color: '#14F195', gradient: 'from-purple-500 to-green-400' },
  { code: 'MATIC', name: 'Polygon', icon: 'M', color: '#8247E5', gradient: 'from-purple-600 to-indigo-600' },
  { code: 'AVAX', name: 'Avalanche', icon: 'A', color: '#E84142', gradient: 'from-red-500 to-pink-600' }
];
...
export default function SavingsVault() {
  ...
  // Use ALL_SUPPORTED_COINS directly - always show them
  const supportedCoins = ALL_SUPPORTED_COINS;
