...
import { IoFlash, IoSearch, IoFilter, IoTrendingUp, IoTrendingDown, IoShield, IoStar, IoTime, IoCheckmarkCircle, IoPersonOutline, IoCash } from 'react-icons/io5';;
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            >
              {cryptos.map(crypto => (
                <option key={crypto} value={crypto}>{getCryptoEmoji(crypto)} {crypto}</option>
              ))}
            </select>
          </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                      ...
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ 
                          ...
                          {getCryptoEmoji(selectedCrypto)} {item.advert.price_per_unit} {selectedFiat}
                        </div>
