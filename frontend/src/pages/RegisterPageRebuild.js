        ...
        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              />
              <label htmlFor="accept-terms-rebuild" className="text-sm text-gray-300">
                I accept the <Link to="/terms" className="text-purple-400 hover:text-purple-300 underline">Terms of Service</Link> and <Link to="/privacy" className="text-purple-400 hover:text-purple-300 underline">Privacy Policy</Link>
              </label>
            </div>
