...
**URL:** https://gridbot-app.preview.emergentagent.com/admin/business
...
### **Access:**
1. Go to: https://gridbot-app.preview.emergentagent.com/admin/login
2. Login with:
...
**Access URLs:**
- Login: https://gridbot-app.preview.emergentagent.com/admin/login
- Business Dashboard: https://gridbot-app.preview.emergentagent.com/admin/business
- Earnings Dashboard: https://gridbot-app.preview.emergentagent.com/admin/earnings
