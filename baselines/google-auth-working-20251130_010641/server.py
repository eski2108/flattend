...
async def google_auth():
    ...
    try:
        ...
        redirect_uri = "https://controlpanel-4.preview.emergentagent.com/api/auth/google/callback"
...
async def forgot_password(request: ForgotPasswordRequest, req: Request):
    ...
    try:
        ...
        reset_link = f"https://controlpanel-4.preview.emergentagent.com/reset-password?token={reset_token}"
