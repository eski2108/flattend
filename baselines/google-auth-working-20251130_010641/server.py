...
async def google_auth():
    ...
    try:
        ...
        redirect_uri = "https://protrading.preview.emergentagent.com/api/auth/google/callback"
...
async def forgot_password(request: ForgotPasswordRequest, req: Request):
    ...
    try:
        ...
        reset_link = f"https://protrading.preview.emergentagent.com/reset-password?token={reset_token}"
