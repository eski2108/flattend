...
**How to Test:**
1. Go to: https://tradefix-preview.preview.emergentagent.com/auth
...
- Redirect URI: `https://tradefix-preview.preview.emergentagent.com/api/auth/google/callback`

**How to Test:**
1. Open browser DevTools (F12)
2. Go to Console tab
3. Go to: https://tradefix-preview.preview.emergentagent.com/auth
...
```bash
curl -X POST "https://tradefix-preview.preview.emergentagent.com/api/auth/phone/send-otp" \
...
```bash
curl "https://tradefix-preview.preview.emergentagent.com/api/auth/google"
```
