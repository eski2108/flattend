...
- Connected to production backend: `https://tradingplatform-14.preview.emergentagent.com`
...
```bash
curl "https://tradingplatform-14.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
