...
- Connected to production backend: `https://spottrading-fix.preview.emergentagent.com`
...
```bash
curl "https://spottrading-fix.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
