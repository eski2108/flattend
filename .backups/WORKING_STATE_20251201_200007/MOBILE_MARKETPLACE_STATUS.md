...
- Connected to production backend: `https://codehealer-31.preview.emergentagent.com`
...
```bash
curl "https://codehealer-31.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
