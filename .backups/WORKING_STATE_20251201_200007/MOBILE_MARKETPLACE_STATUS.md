...
- Connected to production backend: `https://cryptospeed.preview.emergentagent.com`
...
```bash
curl "https://cryptospeed.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
