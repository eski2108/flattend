...
- Connected to production backend: `https://liquidity-hub-4.preview.emergentagent.com`
...
```bash
curl "https://liquidity-hub-4.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
