...
**Test:**
```bash
curl https://p2p-market-1.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://p2p-market-1.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
