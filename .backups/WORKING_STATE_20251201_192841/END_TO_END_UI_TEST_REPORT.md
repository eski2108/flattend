...
**Test:**
```bash
curl https://p2p-trader-board.preview.emergentagent.com/api/wallets/balances/test_user_alice
```
...
**Test:**
```bash
curl https://p2p-trader-board.preview.emergentagent.com/api/wallets/portfolio/test_user_alice
```
