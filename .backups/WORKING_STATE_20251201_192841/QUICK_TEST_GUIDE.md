...
**Test Flow**:
1. Open browser: `https://dual-currency-crypto.preview.emergentagent.com`
...
curl https://dual-currency-crypto.preview.emergentagent.com/api/referrals/purchase-vip
