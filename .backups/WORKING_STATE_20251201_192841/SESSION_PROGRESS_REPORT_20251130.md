...
```bash
$ curl https://dual-currency-crypto.preview.emergentagent.com/api/admin/fees/test
{"success": true, "message": "Fee endpoints are working!"}

$ curl https://dual-currency-crypto.preview.emergentagent.com/api/admin/fees/all
{
  "success": true,
  "fees": {
