...
- Connected to production backend: `https://tradefix-preview.preview.emergentagent.com`
...
```bash
curl "https://tradefix-preview.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
