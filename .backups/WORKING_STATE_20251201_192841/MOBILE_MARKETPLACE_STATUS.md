...
- Connected to production backend: `https://cryptosupport-1.preview.emergentagent.com`
...
```bash
curl "https://cryptosupport-1.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
