...
- Connected to production backend: `https://tradeliquidity.preview.emergentagent.com`
...
```bash
curl "https://tradeliquidity.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
