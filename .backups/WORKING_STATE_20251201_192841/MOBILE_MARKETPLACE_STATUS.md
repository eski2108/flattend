...
- Connected to production backend: `https://coinfix.preview.emergentagent.com`
...
```bash
curl "https://coinfix.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
