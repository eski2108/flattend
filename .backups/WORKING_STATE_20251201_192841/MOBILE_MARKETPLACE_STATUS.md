...
- Connected to production backend: `https://referboost-4.preview.emergentagent.com`
...
```bash
curl "https://referboost-4.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
