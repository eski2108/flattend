...
- Connected to production backend: `https://cryptovault-29.preview.emergentagent.com`
...
```bash
curl "https://cryptovault-29.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
