...
- Connected to production backend: `https://coinhubpro.preview.emergentagent.com`
...
```bash
curl "https://coinhubpro.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
