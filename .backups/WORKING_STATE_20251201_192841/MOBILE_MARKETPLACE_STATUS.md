...
- Connected to production backend: `https://dual-currency-crypto.preview.emergentagent.com`
...
```bash
curl "https://dual-currency-crypto.preview.emergentagent.com/api/marketplace/list?offer_type=sell&crypto=BTC&fiat=GBP"
```
