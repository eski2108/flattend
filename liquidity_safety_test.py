...
Backend URL: https://liquidity-hub-4.preview.emergentagent.com
"""
...
# Configuration
BACKEND_URL = "https://liquidity-hub-4.preview.emergentagent.com"
...
class LiquiditySafetyTester:
    ...
    async def create_test_user(self):
        ...
        balance_result = await self.db.internal_balances.update_one(
