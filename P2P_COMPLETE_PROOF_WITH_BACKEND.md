...
### USER VISIBLE:
✅ YES - Go to https://tradingplatform-14.preview.emergentagent.com/instant-buy
✅ Expand any coin
...
**1. Add Favourite**
```bash
curl -X POST https://tradingplatform-14.preview.emergentagent.com/api/p2p/favourites/add \
...
**2. Remove Favourite**
```bash
curl -X POST https://tradingplatform-14.preview.emergentagent.com/api/p2p/favourites/remove \
  -H "Content-Type: application/json" \
  -d '{"user_id":"test","merchant_id":"seller123"}'
...
**3. Get Favourites**
```bash
curl https://tradingplatform-14.preview.emergentagent.com/api/p2p/favourites/test
...
**Submit Feedback**
```bash
curl -X POST https://tradingplatform-14.preview.emergentagent.com/api/p2p/trade/proof_trade_123/feedback \
  -H "Content-Type: application/json" \
  -d '{
...
**Get Feedback**
```bash
curl "https://tradingplatform-14.preview.emergentagent.com/api/p2p/trader/seller_proof/feedback"
...
**1. Block User**
```bash
curl -X POST https://tradingplatform-14.preview.emergentagent.com/api/p2p/block/add \
  -H "Content-Type: application/json" \
...
**2. Unblock User**
```bash
curl -X POST https://tradingplatform-14.preview.emergentagent.com/api/p2p/block/remove \
  -H "Content-Type: application/json" \
  -d '{"user_id":"test","blocked_user_id":"baduser"}'
...
**3. Get Blocked List**
```bash
curl https://tradingplatform-14.preview.emergentagent.com/api/p2p/blocked/test
...
**Resolve Dispute**
```bash
curl -X POST https://tradingplatform-14.preview.emergentagent.com/api/admin/p2p/dispute/trade123/resolve \
  -H "Content-Type: application/json" \
  -d '{
    "admin_id": "admin_user",
    "winner": "buyer",
...
<a href="https://tradingplatform-14.preview.emergentagent.com/p2p/order/trade123">View Order</a>
```
...
**Get Stats**
```bash
curl "https://tradingplatform-14.preview.emergentagent.com/api/admin/p2p/stats?timeframe=week"
...
### USER VISIBLE:
✅ YES - Go to https://tradingplatform-14.preview.emergentagent.com/admin/p2p
