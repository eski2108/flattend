...
Status: DEPLOYED TO https://quickstart-27.preview.emergentagent.com
```
...
```bash
$ curl -s https://quickstart-27.preview.emergentagent.com/api/health
{"status":"healthy","service":"coinhubx-backend","timestamp":"2025-12-09T16:05:00"}
```

### NOWPayments Integration Active:
```bash
$ curl -s "https://quickstart-27.preview.emergentagent.com/api/nowpayments/currencies" | python3 -m json.tool | head -n 10
{
    "success": true,
    "currencies": [
        "usdtmatic",
...
#### Test 1: Deposit Page
```
1. Open: https://quickstart-27.preview.emergentagent.com
...
**Commit:** 4eec5e24935ee454e6fe27f2132f61fbb901cc3c
**Build:** Stable
**Deployment:** Live at https://quickstart-27.preview.emergentagent.com
