...
- ❌ **WRONG:** `https://savingsflow.preview.emergentagent.com/admin/disputes/{dispute_id}`
- ✅ **CORRECT:** `https://savingsflow.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
...
3. **Click Email Button**
   ...
   - Should navigate to: `https://savingsflow.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
