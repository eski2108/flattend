...
- ❌ **WRONG:** `https://peer-listings.preview.emergentagent.com/admin/disputes/{dispute_id}`
- ✅ **CORRECT:** `https://peer-listings.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
...
3. **Click Email Button**
   ...
   - Should navigate to: `https://peer-listings.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
