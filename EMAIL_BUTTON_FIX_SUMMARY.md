...
- ❌ **WRONG:** `https://gridbot-app.preview.emergentagent.com/admin/disputes/{dispute_id}`
- ✅ **CORRECT:** `https://gridbot-app.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
...
1. **Line 197** - Main Action Button URL
   ```html
   <a href="https://gridbot-app.preview.emergentagent.com/#/admin/disputes/{dispute_id}">
   ```
...
3. **Click Email Button**
   ...
   - Should navigate to: `https://gridbot-app.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
