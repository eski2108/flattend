...
- ❌ **WRONG:** `https://express-buy-flow.preview.emergentagent.com/admin/disputes/{dispute_id}`
- ✅ **CORRECT:** `https://express-buy-flow.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
...
3. **Click Email Button**
   ...
   - Should navigate to: `https://express-buy-flow.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
