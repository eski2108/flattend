...
- ❌ **WRONG:** `https://wallet-nav-repair.preview.emergentagent.com/admin/disputes/{dispute_id}`
- ✅ **CORRECT:** `https://wallet-nav-repair.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
...
3. **Click Email Button**
   ...
   - Should navigate to: `https://wallet-nav-repair.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
