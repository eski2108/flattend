...
- ❌ **WRONG:** `https://layout-restore-2.preview.emergentagent.com/admin/disputes/{dispute_id}`
- ✅ **CORRECT:** `https://layout-restore-2.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
...
1. **Line 197** - Main Action Button URL
   ```html
   <a href="https://layout-restore-2.preview.emergentagent.com/#/admin/disputes/{dispute_id}">
   ```
...
3. **Click Email Button**
   ...
   - Should navigate to: `https://layout-restore-2.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
