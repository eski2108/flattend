...
- ❌ **WRONG:** `https://crypto-logo-update.preview.emergentagent.com/admin/disputes/{dispute_id}`
- ✅ **CORRECT:** `https://crypto-logo-update.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
...
3. **Click Email Button**
   ...
   - Should navigate to: `https://crypto-logo-update.preview.emergentagent.com/#/admin/disputes/{dispute_id}`
