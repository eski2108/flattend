...
```bash
$ curl https://crypto-exchange-fix.preview.emergentagent.com/api/admin/fees/test
{"success": true, "message": "Fee endpoints are working!"}

$ curl https://crypto-exchange-fix.preview.emergentagent.com/api/admin/fees/all
{
  "success": true,
  "fees": {
