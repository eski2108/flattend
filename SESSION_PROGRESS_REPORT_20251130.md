...
```bash
$ curl https://crypto-exchange-hub-12.preview.emergentagent.com/api/admin/fees/test
{"success": true, "message": "Fee endpoints are working!"}

$ curl https://crypto-exchange-hub-12.preview.emergentagent.com/api/admin/fees/all
{
  "success": true,
  "fees": {
