...
```bash
$ curl https://multilingual-crypto-2.preview.emergentagent.com/api/admin/fees/test
{"success": true, "message": "Fee endpoints are working!"}

$ curl https://multilingual-crypto-2.preview.emergentagent.com/api/admin/fees/all
{
  "success": true,
  "fees": {
