...
### Technology Stack
- React Native (Expo)
- Pointing to same backend: `https://p2p-bestmatch.preview.emergentagent.com/api`
...
### Access
- URL: `https://p2p-bestmatch.preview.emergentagent.com/savings`
...
### Endpoint Base
- Web: `https://p2p-bestmatch.preview.emergentagent.com/api`
- Mobile: `https://p2p-bestmatch.preview.emergentagent.com/api` (SAME)
...
1. **Web App (Frontend)**
   ...
   - Deployed to: `https://p2p-bestmatch.preview.emergentagent.com`
   - Updates: Automatic on restart
   - Mobile access: Via mobile browser (Safari/Chrome)

2. **Backend API**
   - Code location: `/app/backend/server.py`
   - Deployed to: `https://p2p-bestmatch.preview.emergentagent.com/api`
   - Updates: Automatic on restart
...
- Go to: `https://p2p-bestmatch.preview.emergentagent.com/savings`
...
2. Navigate to: `https://p2p-bestmatch.preview.emergentagent.com/savings`
