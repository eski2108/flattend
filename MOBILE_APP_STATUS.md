...
### Technology Stack
- React Native (Expo)
- Pointing to same backend: `https://crypto-alert-hub-2.preview.emergentagent.com/api`
...
### Access
- URL: `https://crypto-alert-hub-2.preview.emergentagent.com/savings`
...
### Endpoint Base
- Web: `https://crypto-alert-hub-2.preview.emergentagent.com/api`
- Mobile: `https://crypto-alert-hub-2.preview.emergentagent.com/api` (SAME)
...
1. **Web App (Frontend)**
   ...
   - Deployed to: `https://crypto-alert-hub-2.preview.emergentagent.com`
   - Updates: Automatic on restart
   - Mobile access: Via mobile browser (Safari/Chrome)

2. **Backend API**
   - Code location: `/app/backend/server.py`
   - Deployed to: `https://crypto-alert-hub-2.preview.emergentagent.com/api`
   - Updates: Automatic on restart
...
- Go to: `https://crypto-alert-hub-2.preview.emergentagent.com/savings`
...
2. Navigate to: `https://crypto-alert-hub-2.preview.emergentagent.com/savings`
