...
### Technology Stack
- React Native (Expo)
- Pointing to same backend: `https://layout-restore-2.preview.emergentagent.com/api`
...
### Access
- URL: `https://layout-restore-2.preview.emergentagent.com/savings`
...
### Endpoint Base
- Web: `https://layout-restore-2.preview.emergentagent.com/api`
- Mobile: `https://layout-restore-2.preview.emergentagent.com/api` (SAME)
...
1. **Web App (Frontend)**
   ...
   - Deployed to: `https://layout-restore-2.preview.emergentagent.com`
   - Updates: Automatic on restart
   - Mobile access: Via mobile browser (Safari/Chrome)

2. **Backend API**
   - Code location: `/app/backend/server.py`
   - Deployed to: `https://layout-restore-2.preview.emergentagent.com/api`
   - Updates: Automatic on restart
...
- Go to: `https://layout-restore-2.preview.emergentagent.com/savings`
...
2. Navigate to: `https://layout-restore-2.preview.emergentagent.com/savings`
