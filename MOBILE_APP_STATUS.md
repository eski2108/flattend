...
### Technology Stack
- React Native (Expo)
- Pointing to same backend: `https://wallet-nav-repair.preview.emergentagent.com/api`
...
### Access
- URL: `https://wallet-nav-repair.preview.emergentagent.com/savings`
...
### Endpoint Base
- Web: `https://wallet-nav-repair.preview.emergentagent.com/api`
- Mobile: `https://wallet-nav-repair.preview.emergentagent.com/api` (SAME)
...
1. **Web App (Frontend)**
   ...
   - Deployed to: `https://wallet-nav-repair.preview.emergentagent.com`
   - Updates: Automatic on restart
   - Mobile access: Via mobile browser (Safari/Chrome)

2. **Backend API**
   - Code location: `/app/backend/server.py`
   - Deployed to: `https://wallet-nav-repair.preview.emergentagent.com/api`
   - Updates: Automatic on restart
...
- Go to: `https://wallet-nav-repair.preview.emergentagent.com/savings`
...
2. Navigate to: `https://wallet-nav-repair.preview.emergentagent.com/savings`
