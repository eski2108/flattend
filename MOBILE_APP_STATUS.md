...
### Technology Stack
- React Native (Expo)
- Pointing to same backend: `https://controlpanel-4.preview.emergentagent.com/api`
...
### Access
- URL: `https://controlpanel-4.preview.emergentagent.com/savings`
...
### Endpoint Base
- Web: `https://controlpanel-4.preview.emergentagent.com/api`
- Mobile: `https://controlpanel-4.preview.emergentagent.com/api` (SAME)
...
1. **Web App (Frontend)**
   ...
   - Deployed to: `https://controlpanel-4.preview.emergentagent.com`
   - Updates: Automatic on restart
   - Mobile access: Via mobile browser (Safari/Chrome)

2. **Backend API**
   - Code location: `/app/backend/server.py`
   - Deployed to: `https://controlpanel-4.preview.emergentagent.com/api`
   - Updates: Automatic on restart
...
- Go to: `https://controlpanel-4.preview.emergentagent.com/savings`
...
2. Navigate to: `https://controlpanel-4.preview.emergentagent.com/savings`
