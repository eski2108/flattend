...
### Technology Stack
- React Native (Expo)
- Pointing to same backend: `https://finance-check-5.preview.emergentagent.com/api`
...
### Access
- URL: `https://finance-check-5.preview.emergentagent.com/savings`
...
### Endpoint Base
- Web: `https://finance-check-5.preview.emergentagent.com/api`
- Mobile: `https://finance-check-5.preview.emergentagent.com/api` (SAME)
...
1. **Web App (Frontend)**
   ...
   - Deployed to: `https://finance-check-5.preview.emergentagent.com`
   - Updates: Automatic on restart
   - Mobile access: Via mobile browser (Safari/Chrome)

2. **Backend API**
   - Code location: `/app/backend/server.py`
   - Deployed to: `https://finance-check-5.preview.emergentagent.com/api`
   - Updates: Automatic on restart
...
- Go to: `https://finance-check-5.preview.emergentagent.com/savings`
...
2. Navigate to: `https://finance-check-5.preview.emergentagent.com/savings`
