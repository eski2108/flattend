...
### Technology Stack
- React Native (Expo)
- Pointing to same backend: `https://peer-listings.preview.emergentagent.com/api`
...
### Access
- URL: `https://peer-listings.preview.emergentagent.com/savings`
...
### Endpoint Base
- Web: `https://peer-listings.preview.emergentagent.com/api`
- Mobile: `https://peer-listings.preview.emergentagent.com/api` (SAME)
...
1. **Web App (Frontend)**
   ...
   - Deployed to: `https://peer-listings.preview.emergentagent.com`
   - Updates: Automatic on restart
   - Mobile access: Via mobile browser (Safari/Chrome)

2. **Backend API**
   - Code location: `/app/backend/server.py`
   - Deployed to: `https://peer-listings.preview.emergentagent.com/api`
   - Updates: Automatic on restart
...
- Go to: `https://peer-listings.preview.emergentagent.com/savings`
...
2. Navigate to: `https://peer-listings.preview.emergentagent.com/savings`
