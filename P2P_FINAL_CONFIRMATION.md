...
```bash
$ curl https://tradinghub-7.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://tradinghub-7.preview.emergentagent.com/api/p2p/marketplace/offers
