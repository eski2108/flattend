...
```bash
$ curl https://finance-check-5.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://finance-check-5.preview.emergentagent.com/api/p2p/marketplace/offers
