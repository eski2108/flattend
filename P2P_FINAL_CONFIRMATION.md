...
```bash
$ curl https://atomic-pay-fix.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://atomic-pay-fix.preview.emergentagent.com/api/p2p/marketplace/offers
