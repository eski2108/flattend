...
```bash
$ curl https://gridbot-app.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://gridbot-app.preview.emergentagent.com/api/p2p/marketplace/offers
