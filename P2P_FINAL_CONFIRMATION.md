...
```bash
$ curl https://premium-wallet-hub.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://premium-wallet-hub.preview.emergentagent.com/api/p2p/marketplace/offers
