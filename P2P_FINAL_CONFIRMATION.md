...
```bash
$ curl https://express-buy-flow.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://express-buy-flow.preview.emergentagent.com/api/p2p/marketplace/offers
