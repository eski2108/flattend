...
```bash
$ curl https://trading-perf-boost.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://trading-perf-boost.preview.emergentagent.com/api/p2p/marketplace/offers
