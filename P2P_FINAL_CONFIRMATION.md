...
```bash
$ curl https://coin-icon-fixer.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://coin-icon-fixer.preview.emergentagent.com/api/p2p/marketplace/offers
