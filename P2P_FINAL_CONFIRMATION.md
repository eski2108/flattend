...
```bash
$ curl https://monitorcrypto.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://monitorcrypto.preview.emergentagent.com/api/p2p/marketplace/offers
