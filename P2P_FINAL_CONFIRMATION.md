...
```bash
$ curl https://walletfix.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://walletfix.preview.emergentagent.com/api/p2p/marketplace/offers
