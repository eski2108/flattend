...
```bash
$ curl https://quickstart-27.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://quickstart-27.preview.emergentagent.com/api/p2p/marketplace/offers
