...
```bash
$ curl https://crypto-logo-update.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://crypto-logo-update.preview.emergentagent.com/api/p2p/marketplace/offers
