...
```bash
$ curl https://crypto-trust-guard.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://crypto-trust-guard.preview.emergentagent.com/api/p2p/marketplace/offers
