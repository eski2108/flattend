...
```bash
$ curl https://peer-listings.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://peer-listings.preview.emergentagent.com/api/p2p/marketplace/offers
