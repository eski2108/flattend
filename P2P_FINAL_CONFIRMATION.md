...
```bash
$ curl https://controlpanel-4.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://controlpanel-4.preview.emergentagent.com/api/p2p/marketplace/offers
