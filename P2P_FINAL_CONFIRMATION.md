...
```bash
$ curl https://tradehub-268.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://tradehub-268.preview.emergentagent.com/api/p2p/marketplace/offers
