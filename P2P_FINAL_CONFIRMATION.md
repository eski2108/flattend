...
```bash
$ curl https://tradewatch-13.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://tradewatch-13.preview.emergentagent.com/api/p2p/marketplace/offers
