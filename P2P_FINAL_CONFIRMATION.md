...
```bash
$ curl https://musing-brown-1.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://musing-brown-1.preview.emergentagent.com/api/p2p/marketplace/offers
