...
```bash
$ curl https://coinhub-rescue.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://coinhub-rescue.preview.emergentagent.com/api/p2p/marketplace/offers
