...
```bash
$ curl https://p2p-repair-1.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://p2p-repair-1.preview.emergentagent.com/api/p2p/marketplace/offers
