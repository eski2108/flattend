...
```bash
$ curl https://tradingbots-ui.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://tradingbots-ui.preview.emergentagent.com/api/p2p/marketplace/offers
