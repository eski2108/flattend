...
```bash
$ curl https://botengine.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://botengine.preview.emergentagent.com/api/p2p/marketplace/offers
