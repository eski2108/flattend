...
```bash
$ curl https://p2pdispute.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://p2pdispute.preview.emergentagent.com/api/p2p/marketplace/offers
