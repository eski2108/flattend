...
```bash
$ curl https://multilingual-crypto-2.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://multilingual-crypto-2.preview.emergentagent.com/api/p2p/marketplace/offers
