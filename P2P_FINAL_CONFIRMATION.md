...
```bash
$ curl https://bugsecurehub.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://bugsecurehub.preview.emergentagent.com/api/p2p/marketplace/offers
