...
```bash
$ curl https://crypto-alert-hub-2.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://crypto-alert-hub-2.preview.emergentagent.com/api/p2p/marketplace/offers
