...
```bash
$ curl https://crypto-wallet-ui-3.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://crypto-wallet-ui-3.preview.emergentagent.com/api/p2p/marketplace/offers
