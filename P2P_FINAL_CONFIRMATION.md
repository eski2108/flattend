...
```bash
$ curl https://p2p-bestmatch.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://p2p-bestmatch.preview.emergentagent.com/api/p2p/marketplace/offers
