...
```bash
$ curl https://payflow-crypto-3.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://payflow-crypto-3.preview.emergentagent.com/api/p2p/marketplace/offers
