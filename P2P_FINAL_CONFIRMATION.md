...
```bash
$ curl https://tradingbot-hub-13.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://tradingbot-hub-13.preview.emergentagent.com/api/p2p/marketplace/offers
