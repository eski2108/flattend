...
```bash
$ curl https://trading-rebuild.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://trading-rebuild.preview.emergentagent.com/api/p2p/marketplace/offers
