...
```bash
$ curl https://fixdisputeflow.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://fixdisputeflow.preview.emergentagent.com/api/p2p/marketplace/offers
