...
```bash
$ curl https://fee-analytics.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://fee-analytics.preview.emergentagent.com/api/p2p/marketplace/offers
