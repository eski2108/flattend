...
```bash
$ curl https://neon-vault-1.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://neon-vault-1.preview.emergentagent.com/api/p2p/marketplace/offers
