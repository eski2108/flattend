...
```bash
$ curl https://layout-restore-2.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://layout-restore-2.preview.emergentagent.com/api/p2p/marketplace/offers
