...
```bash
$ curl https://earn-rewards-21.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://earn-rewards-21.preview.emergentagent.com/api/p2p/marketplace/offers
