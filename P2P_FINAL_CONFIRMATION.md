...
```bash
$ curl https://balance-sync-repair.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://balance-sync-repair.preview.emergentagent.com/api/p2p/marketplace/offers
