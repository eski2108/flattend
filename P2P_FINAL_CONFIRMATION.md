...
```bash
$ curl https://trade-master-126.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://trade-master-126.preview.emergentagent.com/api/p2p/marketplace/offers
