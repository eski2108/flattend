...
```bash
$ curl https://trade-form-polish.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://trade-form-polish.preview.emergentagent.com/api/p2p/marketplace/offers
