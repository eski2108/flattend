...
```bash
$ curl https://pixelperfect-trade.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://pixelperfect-trade.preview.emergentagent.com/api/p2p/marketplace/offers
