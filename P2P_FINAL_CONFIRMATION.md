...
```bash
$ curl https://crypto-2fa-update.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://crypto-2fa-update.preview.emergentagent.com/api/p2p/marketplace/offers
