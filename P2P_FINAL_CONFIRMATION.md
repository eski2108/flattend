...
```bash
$ curl https://i18n-p2p-fixes.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://i18n-p2p-fixes.preview.emergentagent.com/api/p2p/marketplace/offers
