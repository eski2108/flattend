...
```bash
$ curl https://crypto-botui.preview.emergentagent.com/api/p2p/marketplace/available-coins
...
```bash
$ curl https://crypto-botui.preview.emergentagent.com/api/p2p/marketplace/offers
